import { ApiResponse, Asset, Company, Project, RelationshipValue, Skill } from "@/types";
...
export const extractSkill = (response: ApiResponse<any, Skill>, skillId: string) => {
...
export const extractCompany = (response: ApiResponse<any, Company>, companyId: string) => {
